...
use crate::contract_caller::order_builder::order_builder::calculate_market_increase_order_params;
use dotenv::dotenv;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let test_result: OrderCalcOutput = calculate_market_increase_order_params(test).await?;
